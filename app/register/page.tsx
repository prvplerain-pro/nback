...
function RegisterForm() {
  ...
  return (
    <main style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px', background: '#08080f' }}>
      <div style={{ width: '100%', maxWidth: '360px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
          <input
            ...
            style={{ width: '100%', padding: '12px 14px', borderRadius: '10px', background: '#0e0e1a', border: '0.5px solid rgba(130,110,255,0.2)', color: '#e8e6ff', fontSize: '14px', outline: 'none' }}
          />
          <input
            type="password"
            placeholder="heslo"
          ...
          <button
            ...
            disabled={loading}
            style={{ width: '100%', padding: '12px', borderRadius: '10px', background: '#6c5ce7', color: '#fff', border: 'none', fontSize: '14px', fontWeight: 500, cursor: 'pointer', opacity: loading ? 0.6 : 1 }}
          >
